...
const testVideos = [
  ...
  // Additional videos for extrapolation examples (Session 644)
  {
    ...
    label: "improvised",
    split: "dev",
    fileId1: "V00_S0644_I00000131_P0799",
    fileId2: "V00_S0644_I00000131_P0800",
  },
  {
    videoId: "V00_S0644_I00000132",
    vendorId: 0,
    sessionId: 644,
    interactionId: 132,
    participant1Id: "0799",
    ...
    label: "improvised",
    split: "dev",
    fileId1: "V00_S0644_I00000132_P0799",
    fileId2: "V00_S0644_I00000132_P0800",
  },
  // Additional videos for extrapolation examples (Session 1)
  {
    ...
    label: "naturalistic",
    split: "dev",
    fileId1: "V00_S0001_I00000004_P0003",
    fileId2: "V00_S0001_I00000004_P0004",
  },
  {
    videoId: "V00_S0001_I00000005",
    vendorId: 0,
    sessionId: 1,
    interactionId: 5,
    participant1Id: "0003",
    ...
    label: "naturalistic",
    split: "dev",
    fileId1: "V00_S0001_I00000005_P0003",
    fileId2: "V00_S0001_I00000005_P0004",
  },
];
...
const testAnnotations = [
  ...
  // Extrapolated annotations - Session 644
  // These were extrapolated from V00_S0644_I00000129 (same speakers, same morph labels)
  {
    videoId: "V00_S0644_I00000131",
    vendorId: 0,
    sessionId: 644,
    ...
    speaker1Comments: "",
    speaker2Comments: "",
    // All behavioral signals empty for extrapolated annotations
    speaker1Prosody: [],
    speaker1LexicalChoice: [],
    speaker1TurnTaking: [],
    speaker1Gaze: [],
  ...
  // Extrapolated annotations - Session 1
  // These were extrapolated from V00_S0001_I00000002 (same speakers, same morph labels)
  {
    videoId: "V00_S0001_I00000004",
    vendorId: 0,
    sessionId: 1,
  ...
  if (format === "json") {
    ...
    const csvStringifier = createObjectCsvStringifier({
      header: [
        ...
        { id: "annotationType", title: "annotationType" },
